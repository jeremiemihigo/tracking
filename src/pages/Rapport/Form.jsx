  ...
  return (
    <div style={{ width: '30rem' }}>
      <Grid container>
        ...
        <Grid item lg={8} sx={{ padding: '2px', marginTop: '8px' }}>
          <AutoComplement value={roleSelect} setValue={setRoleSelect} options={roles} title="Role" propr="title" />
        </Grid>
        <Grid item lg={2} sx={{ padding: '2px', display: 'flex', marginTop: '8px', alignItems: 'center', justifyContent: 'center' }}>
          {step !== '' ? (
            step
          ) : (
            <Button onClick={(e) => sendRecherche(e)} color="primary" variant="contained">
